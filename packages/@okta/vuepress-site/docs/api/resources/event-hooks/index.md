...
|----------------|---------------------------------------------------------------------------------------------------|-----------------------------------|----------|--------|----------|---------------------------------------------------|
| id             | Unique key for the Event Hook.                                                                   | String                            | FALSE    | TRUE   | TRUE     | Assigned                                          |
| status         | Status of the Event Hook. `INACTIVE` will not receive any events.                                       | String                            | FALSE    | FALSE  | FALSE    | Assigned. Will be either `ACTIVE` or `INACTIVE`.            |
| verificationStatus         | Verification status of the Event Hook. `UNVERIFIED` will not receive any events.                                       | String                            | FALSE    | FALSE  | FALSE    | Assigned. Will be either `VERIFIED` or `UNVERIFIED`.            |
...
| created        | Date of Event Hook creation.                                                                     | String (Date)                     | TRUE     | FALSE  | TRUE     | Assigned                                          |
| lastUpdated    | Date of Event Hook update.                                                                       | String (Date)                     | TRUE     | FALSE  | TRUE     | Assigned                                          |
...
| Property       | Description                                                                                         | DataType                            | Nullable   | Unique   | ReadOnly   | Validation                                        |
| -------------- | --------------------------------------------------------------------------------------------------- | ----------------------------------- | ---------- | -------- | ---------- | ------------------------------------------------- |
| type           | Type of the Channel. Currently only `HTTP` type is supported.   | channelType                      | FALSE      | FALSE    | TRUE       | Must match a valid channel type.            |
...
| Property | Description                                                                  | DataType | Required | ReadOnly |
|----------|------------------------------------------------------------------------------|----------|----------|----------|
| type     | The type of the events object. Currently only `EVENT_TYPE` is supported.     | String   | TRUE     | FALSE    |
